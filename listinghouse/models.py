...
from immobilien.models import immobilien
...
class Listings(models.Model):
    ...
    class HomeType(models.TextChoices):
        ...
        CONDO = 'Condo'
        TOWNHOUSE = 'Townhouse'
    imobile = models.ForeignKey(immobilien, on_delete=models.CASCADE)
    ...
    sale_type = models.CharField(
        max_length=100, choices=SaleType.choices, default=SaleType.FOR_SALE)
