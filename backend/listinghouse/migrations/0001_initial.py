# Generated by Django 3.0.8 on 2020-08-05 01:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house_type', models.CharField(choices=[('For Sale', 'House'), ('For Rent', 'Condo'), ('Townhouse', 'Townhouse')], default='For Sale', max_length=100)),
                ...
                ('imobile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='immobilien.immobilien')),
            ],
        ),
    ]
