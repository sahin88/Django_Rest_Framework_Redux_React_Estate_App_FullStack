...
class LoginView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        print('Serialized_datra', serializer.validated_data)
    ...
    def get(self, request, uidb64, token):
        try:
            ...
            if not PasswordResetTokenGenerator().check_token(user, token):
                return Response('Token is not valid please order new One Fuck Trump', status=status.HTTP_401_UNAUTHORIZED)
